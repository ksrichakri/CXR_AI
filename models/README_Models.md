...
If you want additional examples, validation notes, or a migration guide for these models, tell me which format you prefer (OpenAPI schema, JSON Schema, or short usage snippets).
